...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='models/yolov5s-MultiUAV.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='data/MOT-UAV.yaml', help='data.yaml path')
    ...
    if not opt.evolve:
        tb_writer = None
        if opt.local_rank in [-1, 0]:
            print('Start Tensorboard with "tensorboard --logdir=runs", view at http://localhost:6009/')
