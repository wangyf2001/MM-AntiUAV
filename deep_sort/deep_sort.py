...
class DeepSort(object):
    ...
    def update(self, bbox_xywh, confidences, ori_img, is_first_frame=False):
        ...
        features = self._get_features(bbox_xywh, ori_img) #得到每一个bbox的特征
        ...
        detections = [Detection(bbox_tlwh[i], conf, features[i]) for i,conf in enumerate(confidences) if conf>self.min_confidence] #筛选
        ...
        if not is_first_frame:
            ...
            detections = detections #第一帧读取gt 不用 NMS
